...
dice_t *get_pc_damage(void)
{
  //Gonna use a small number due the fact this asusme the PC is barehand
  dice_t *pc_damage_dice = new_dice(0, 1, 4);
  return pc_damage_dice;
}
